...
export function UrlPreview({ username: slug }: UrlPreviewProps) {
    ...
    if (!!username) {
        ...
        return (
            ...
            <div className="flex items-center justify-between flex-1 p-2 text-gray-100 bg-neutral-900 rounded-md">
                ...
                <Link
                    href={`${process.env.NEXT_PUBLIC_HOST_URL}/creator/${username}`}
                    target="_blank"
                    className="bg-blue-500 hover:bg-blue-600 px-4 py-1 rounded-md hidden md:block"
                >
    ...
    return (
        ...
        <div className="w-full">
            ...
            <div className="flex items-center flex-1 p-2 text-gray-100">
                ...
                <form
                    className="flex flex-1 flex-col md:flex-row gap-4 md:items-center"
                    action={submitAction}
                >
                    <div className="flex flex-col md:flex-row w-full md:items-center gap-2">
                        ...
                        <input type="text"
                            className="flex-1 outline-none border h-9 border-gray-300 bg-gray-50 text-black rounded-md w-full md:w-fit px-1"
