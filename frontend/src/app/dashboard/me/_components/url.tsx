...
export function UrlPreview({ username: slug }: UrlPreviewProps) {
    ...
    if (!!username) {
        ...
        return (
            ...
            <div className="flex items-center justify-between flex-1 p-2 text-gray-100 flex-wrap">
                <div
                    className="flex flex-col md:flex-row items-start md:items-center justify-center flex-wrap gap-2 whitespace-normal break-all"
                >
